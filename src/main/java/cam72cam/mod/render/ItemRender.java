...
public class ItemRender {
    ...
    public static void register(CustomItem item, Identifier tex) {
        ...
        ClientEvents.MODEL_BAKE.subscribe(event -> {
            ...
            try {
                Constructor<ItemLayerModel> constructor = ItemLayerModel.class.getDeclaredConstructor(ImmutableList.class, Int2ObjectMap.class, Int2ObjectMap.class);
                constructor.setAccessible(true);
                model = constructor.newInstance(ImmutableList.of(mat), new Int2ObjectArrayMap<>(),
